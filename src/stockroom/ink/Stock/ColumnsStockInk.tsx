...
export const columns: ColumnDef<Stock>[] = [
    ...
    },
    {
        ...
        header: ({ column }) => (
            <div
                className='hover:bg-transparent bg-transparent max-w-1/2 px-0 cursor-pointer'
    ...
    },
    {
        ...
        header: ({ column }) => (
            <div
                className='hover:bg-transparent bg-transparent max-w-1/3 px-0 cursor-pointer'
                onClick={() => column.toggleSorting(column.getIsSorted() === 'asc')}
            >
                Proveedor
            </div>
    ...
    },
    {
        ...
        header: ({ column }) => (
            <div
                className='hover:bg-transparent bg-transparent px-0 cursor-pointer'
                onClick={() => column.toggleSorting(column.getIsSorted() === 'asc')}
            >
                Lote Proveedor
            </div>
...
function StockAction({ row, table }: StockActionProps) {
    ...
    return (
        <div
            className="bg-transparent hover:bg-transparent hover:text-white m-0 p-0 w-5 h-5 transition-colors cursor-pointer"
            onClick={() => {
                setOpen(true);
